  ...
  computed: {
    tableColumns() {
      return [
        ...
        { key: 'discountRatio', label: this.$t('discountRatio'), sortable: true },
  ...
  methods: {
    ...
    remove(item) {
      this.confirmAction(
        ...
        () => {
          // then delete
          this.delete({ url: 'Discounts', id: item.id }).then(() => {
