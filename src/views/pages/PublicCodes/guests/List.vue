  ...
  computed: {
    tableColumns() {
      return [
        ...
        { key: "arabicName", label: this.$t("arabicName") },
        { key: "mobileNumber", label: this.$t("mobileNumber") },
        { key: "guestTypeName", label: this.$t("guestType") },
        { key: "identityTypeName", label: this.$t("identityType") },
        { key: "companionsCount", label: this.$t("companionsCount") },
  ...
  methods: {
    ...
    remove(item) {
      this.confirmAction(
        ...
        () => {
          // then delete
          this.delete({ url: "Guests", id: item.id }).then(() => {
