  ...
  computed: {
    tableColumns() {
      return [
        ...
        { key: 'arabicName', label: this.$t('service'), sortable: true },
        { key: 'serviceCost', label: this.$t('serviceCost'), sortable: true },
        { key: 'serviceStatusName', label: this.$t('status'), sortable: true },
  ...
  methods: {
    getItems() {
      this.get({ url: 'Services' }).then((data) => {
        ...
        data.forEach(element => {
          element.serviceStatusName = this.$t(element.serviceActivityStatus)
        });
      });
    },
    ...
    remove(item) {
      this.confirmAction(
        ...
        () => {
          // then delete
          this.delete({ url: 'Services', id: item.id }).then(() => {
