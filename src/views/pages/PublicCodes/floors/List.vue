  ...
  computed: {
    tableColumns() {
      return [
        ...
        { key: 'arabicName', label: this.$t('floor'), sortable: true },
  ...
  methods: {
    ...
    remove(item) {
      this.confirmAction(
        ...
        () => {
          // then delete
          this.delete({ url: 'Floors', id: item.id }).then(() => {
